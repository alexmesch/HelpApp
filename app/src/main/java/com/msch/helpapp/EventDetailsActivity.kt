...
import com.msch.helpapp.concurrency.FileThread
...
class EventDetailsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        thread {
            eventInfo = FileThread.fileWorksThreadNoCoroutine(applicationContext, listType, EVENTS_INFORMATION).filterIsInstance<EventDetails>()
        }
